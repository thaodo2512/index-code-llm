...
hr
ok "${BOLD}Deployed.${RST} Connect your MCP client FROM YOUR LAPTOP — pick ${BOLD}ONE${RST} option."
info ""
...
info "  Clients do NOT start the tunnel for you — keep it running on the laptop:"
info "    ssh -N -L $HOST_PORT:127.0.0.1:$HOST_PORT $SSH_TARGET        # add -f to background it"
...
info ""
info "${BOLD}Optional laptop wrapper${RST} for day-2 commands — save as 'cgw' on the laptop, chmod +x:"
